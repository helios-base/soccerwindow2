  ...
  : QDialog( parent )
{
  ...
  setWindowTitle( tr( "ActionSequenceOptionWindow" ) );
...
int ActionSequenceOptionWindow::optionNum()
{
  return M_optionNum;
}

void ActionSequenceOptionWindow::inOptionNum(int tmpnum)
{
  M_optionNum = tmpnum;
}

int ActionSequenceOptionWindow::optionMaxNoClick()
{
  return M_optionMaxNoClick;
}

void ActionSequenceOptionWindow::inOptionMaxNoClick(int tmpnum)
{
  M_optionMaxNoClick = tmpnum;
  spinBox->setValue(tmpnum);
}

void ActionSequenceOptionWindow::loadFile()
{
  std::ifstream ifs;
...
void ActionSequenceOptionWindow::coutNum()
{
  std::cout << M_optionNum << std::endl;
  std::cout << M_optionMaxNoClick << std::endl;
}

void ActionSequenceOptionWindow::changeRadioButtonCheck()
{
  if(M_optionNum == 0)
    {
